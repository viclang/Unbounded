...
namespace InfinityComparable.Tests
{
    public abstract class InfinityDateTimeOffsetTestsBase
    {
        ...
        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<TimeSpan>, Infinity<DateTimeOffset>> AddData =
            InfinityMathDataFactory.CreateAddData(_left, _rightTimeSpan, _left + _rightTimeSpan);

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<double>, Infinity<DateTimeOffset>> AddDaysData =
            InfinityMathDataFactory.CreateAddData(_left, _rightDouble, _left.AddDays(_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<double>, Infinity<DateTimeOffset>> AddHoursData =
            InfinityMathDataFactory.CreateAddData(_left, _rightDouble, _left.AddHours(_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<double>, Infinity<DateTimeOffset>> AddMillisecondsData =
            InfinityMathDataFactory.CreateAddData(_left, _rightDouble, _left.AddMilliseconds(_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<double>, Infinity<DateTimeOffset>> AddMinutesData =
            InfinityMathDataFactory.CreateAddData(_left, _rightDouble, _left.AddMinutes(_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<int>, Infinity<DateTimeOffset>> AddMonthsData =
            InfinityMathDataFactory.CreateAddData(_left, (int)_rightDouble, _left.AddMonths((int)_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<double>, Infinity<DateTimeOffset>> AddSecondsData =
            InfinityMathDataFactory.CreateAddData(_left, _rightDouble, _left.AddSeconds(_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<long>, Infinity<DateTimeOffset>> AddTicksData =
            InfinityMathDataFactory.CreateAddData(_left, (long)_rightDouble, _left.AddTicks((long)_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<int>, Infinity<DateTimeOffset>> AddYearsData =
            InfinityMathDataFactory.CreateAddData(_left, (int)_rightDouble, _left.AddYears((int)_rightDouble));

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<DateTimeOffset>, Infinity<TimeSpan>> SubstractDateTimeData =
            InfinityMathDataFactory.CreateSubstractData(_left, _rightDateTime, _left - _rightDateTime);

        protected static TheoryData<Infinity<DateTimeOffset>, Infinity<TimeSpan>, Infinity<DateTimeOffset>> SubstractTimeSpanData =
