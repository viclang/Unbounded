namespace InfinityComparable
{
    public static partial class Infinity
    {
        ...
        public static Infinity<int> Divide(this Infinity<int> left, int right)
            => Divide(left, right, (x, y) => x / y);

        public static Infinity<int> Divide(this int left, Infinity<int> right)
            => Divide(left, right, (x, y) => x / y);
        #endregion
        ...
        public static Infinity<long> Divide(this Infinity<long> left, long right)
            => Divide(left, right, (x, y) => x / y);

        public static Infinity<long> Divide(this long left, Infinity<long> right)
            => Divide(left, right, (x, y) => x / y);
        #endregion
        ...
        public static Infinity<double> Divide(this Infinity<double> left, double right)
            => Divide(left, right, (x, y) => x / y);

        public static Infinity<double> Divide(this double left, Infinity<double> right)
            => Divide(left, right, (x, y) => x / y);
        #endregion
        ...
        public static Infinity<float> Divide(this Infinity<float> left, float right)
            => Divide(left, right, (x, y) => x / y);

        public static Infinity<float> Divide(this float left, Infinity<float> right)
            => Divide(left, right, (x, y) => x / y);
        #endregion
        ...
        where TResult : struct, IEquatable<TResult>, IComparable<TResult>, IComparable
            => left.State switch
            {
                InfinityState.IsFinite => new(divide(left.value, right)),
                InfinityState.IsInfinity => new(true),
                _ => new()
            };
        ...
        where TResult : struct, IEquatable<TResult>, IComparable<TResult>, IComparable
            => right.State switch
            {
                InfinityState.IsFinite => new(divide(left, right.value)),
                InfinityState.IsInfinity => new(true),
                _ => new()
            };
    }
