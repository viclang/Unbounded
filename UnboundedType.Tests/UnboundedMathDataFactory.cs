    ...
    public static class UnboundedMathDataFactory
    {
        ...
        where TResult : struct, IEquatable<TResult>, IComparable<TResult>, IComparable
            => new()
            {
                ...
                { new(UnboundedState.NegativeInfinity), new(right), new(UnboundedState.NegativeInfinity) },
                { new(UnboundedState.PositiveInfinity), new(right), new(UnboundedState.PositiveInfinity) },
                { new(UnboundedState.NegativeInfinity), new(default(TRight)), new(UnboundedState.NegativeInfinity) },
                { new(UnboundedState.PositiveInfinity), new(default(TRight)), new(UnboundedState.PositiveInfinity) },
                { new(left), new(UnboundedState.NegativeInfinity), new(UnboundedState.NegativeInfinity) },
                { new(left), new(UnboundedState.PositiveInfinity), new(UnboundedState.PositiveInfinity) },
                { new(default(TLeft)), new(UnboundedState.NegativeInfinity), new(UnboundedState.NegativeInfinity) },
                { new(default(TLeft)), new(UnboundedState.PositiveInfinity), new(UnboundedState.PositiveInfinity) },
                { new(UnboundedState.PositiveInfinity), new(UnboundedState.PositiveInfinity), new(UnboundedState.PositiveInfinity) },
                { new(UnboundedState.NegativeInfinity), new(UnboundedState.NegativeInfinity), new(UnboundedState.NegativeInfinity) },
                { new(UnboundedState.NegativeInfinity), new(UnboundedState.PositiveInfinity) ,new(UnboundedState.NaN) },
                { new(UnboundedState.PositiveInfinity), new(UnboundedState.NegativeInfinity), new(UnboundedState.NaN) },
            };
